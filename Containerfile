...
RUN : \
  && curl -LO https://github.com/gruntwork-io/cloud-nuke/releases/download/v0.26.0/cloud-nuke_linux_amd64 \
...
RUN : \
  && curl -LO https://github.com/openshift/rosa/releases/download/v1.2.15/rosa-linux-amd64 \
