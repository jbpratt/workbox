...
RUN : \
  && curl -LO https://github.com/openshift-online/ocm-cli/releases/download/v1.0.2/ocm-linux-amd64 \
...
RUN : \
  && curl -LO https://github.com/openshift/rosa/releases/download/v1.2.47/rosa_Linux_x86_64.tar.gz \
...
RUN : \
  && curl -LO https://github.com/openshift/osdctl/releases/download/v0.38.0/osdctl_0.37.0_Linux_x86_64.tar.gz \
