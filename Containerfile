...
RUN : \
  && curl -LO https://github.com/openshift-online/ocm-cli/releases/download/v0.1.63/ocm-linux-amd64 \
...
RUN : \
  && curl -LO https://github.com/gruntwork-io/cloud-nuke/releases/download/v0.11.6/cloud-nuke_linux_amd64 \
...
RUN : \
  && curl -LO https://github.com/openshift/rosa/releases/download/v1.2.2/rosa-linux-amd64 \
