...
RUN : \
  && curl -LO https://github.com/1player/host-spawn/releases/download/1.2.1/host-spawn-x86_64 \
...
RUN : \
  && curl -LO https://github.com/gruntwork-io/cloud-nuke/releases/download/v0.16.4/cloud-nuke_linux_amd64 \
...
RUN : \
  && curl -LO https://github.com/openshift/rosa/releases/download/v1.2.6/rosa-linux-amd64 \
