...
RUN : \
  && curl -LO https://github.com/openshift/rosa/releases/download/v1.2.48/rosa_Linux_x86_64.tar.gz \
...
RUN : \
  && curl -LO https://github.com/openshift/osdctl/releases/download/v0.39.0/osdctl_0.38.0_Linux_x86_64.tar.gz \
