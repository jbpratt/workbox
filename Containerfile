...
RUN : \
  && curl -LO https://github.com/openshift-online/ocm-cli/releases/download/v1.0.4/ocm-linux-amd64 \
...
RUN : \
  && curl -LO https://github.com/openshift/rosa/releases/download/v1.2.52/rosa_Linux_x86_64.tar.gz \
