...
RUN : \
  && curl -LO https://github.com/openshift-online/ocm-cli/releases/download/v0.1.69/ocm-linux-amd64 \
...
RUN : \
  && curl -LO https://github.com/openshift/rosa/releases/download/v1.2.28/rosa-linux-amd64 \
