...
RUN : \
  && curl -LO https://github.com/1player/host-spawn/releases/download/1.3.0/host-spawn-x86_64 \
...
RUN : \
  && curl -LO https://github.com/openshift-online/ocm-cli/releases/download/v0.1.65/ocm-linux-amd64 \
...
RUN : \
  && curl -LO https://github.com/gruntwork-io/cloud-nuke/releases/download/v0.24.0/cloud-nuke_linux_amd64 \
...
RUN : \
  && curl -LO https://github.com/openshift/rosa/releases/download/v1.2.13/rosa-linux-amd64 \
