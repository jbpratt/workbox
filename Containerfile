...
RUN : \
  && curl -LO https://github.com/1player/host-spawn/releases/download/1.5.0/host-spawn-x86_64 \
...
RUN : \
  && curl -LO https://github.com/openshift-online/ocm-cli/releases/download/v0.1.71/ocm-linux-amd64 \
...
RUN : \
  && curl -LO https://github.com/gruntwork-io/cloud-nuke/releases/download/v0.32.0/cloud-nuke_linux_amd64 \
...
RUN : \
  && curl -LO https://github.com/openshift/rosa/releases/download/v1.2.31/rosa-linux-amd64 \
