...
RUN : \
  && curl -LO https://github.com/openshift-online/ocm-cli/releases/download/v1.0.3/ocm-linux-amd64 \
...
RUN : \
  && curl -LO https://github.com/openshift/rosa/releases/download/v1.2.49/rosa_Linux_x86_64.tar.gz \
...
RUN : \
  && curl -LO https://github.com/openshift/osdctl/releases/download/v0.41.0/osdctl_0.38.0_Linux_x86_64.tar.gz \
