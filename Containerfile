...
RUN : \
  && curl -LO https://github.com/openshift-online/ocm-cli/releases/download/v0.1.66/ocm-linux-amd64 \
...
RUN : \
  && curl -LO https://github.com/gruntwork-io/cloud-nuke/releases/download/v0.29.7/cloud-nuke_linux_amd64 \
...
RUN : \
  && curl -LO https://github.com/openshift/rosa/releases/download/v1.2.20/rosa-linux-amd64 \
